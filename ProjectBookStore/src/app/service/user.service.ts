...
export class UserService {
  ...
  public getUser(): Observable<UserModule>[]> {
    const url = `http://localhost:4200/user`;
  ...
  public updateUser(user: User) {
    return this.httpClient.put('http://localhost:4200/user/' + user.id, user);
  }
  public addUser(user: User) {
    return this.httpClient.post('http://localhost:4200/user/', user);
  }
  public getUserData() {
